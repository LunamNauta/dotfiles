...
Singleton{
    ...
    function increaseBrightness(): void{
        ...
        if (monitor) monitor.setBrightness(monitor.brightness + Config.services.brightness_increment);
    }
    ...
    component Monitor: QtObject{
        ...
        function setBrightness(value: real): void {
            ...
            else if (is_ddc) Quickshell.execDetached(["ddcutil", "-b", bus_num, "setvcp", "10", rounded]);
        ...
        function initBrightness(): void {
            ...
            else if (is_ddc) init_proc.command = ["ddcutil", "-b", bus_num, "getvcp", "10", "--brief"];
