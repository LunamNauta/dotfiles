...
wvim.languages = {}
wvim.languages.treesitter = {"cpp", "c", "lua", "python", "rust", "javascript", "html", "cmake"}
wvim.languages.mason_lspconfig = {"clangd", "lua_ls", "pylsp", "rust_analyzer", "ts_ls", "html", "cmake"}
